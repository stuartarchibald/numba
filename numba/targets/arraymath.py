...
def np_trapz(y, x=None, dx=1.0):
    # inspired by:
    # https://github.com/numpy/numpy/blob/7ee52003a8be7d4d83c8837d7a795f759b0a7ba2/numpy/lib/function_base.py#L4040-L4065
    def impl(y, x=None, dx=1.0):
        yarr = np.asarray(y)
        d = _get_d(x, dx)
        ret = np.sum(d * (yarr[..., slice(1, None)] + yarr[..., slice(None, -1)]) / 2.0, -1)
